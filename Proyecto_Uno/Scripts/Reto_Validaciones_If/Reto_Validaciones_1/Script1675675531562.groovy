...
Nombre = WebUI.waitForImagePresent(findTestObject('Reto_Validaciones/Page_DEMOQA/input_Name_firstName'), 2)

Apellido = WebUI.waitForImagePresent(findTestObject('Reto_Validaciones/Page_DEMOQA/input_Name_lastName'), 2)
